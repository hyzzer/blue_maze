...
fn tilemap_spawn_system(
    ...
    let start_x = - (board_size.x as f32 / 2. + 1.) * TILE_SIZE.0 - TILE_SIZE.0 / 2.;
    let start_y = (board_size.y as f32 / 2. + 4.) * TILE_SIZE.1 - TILE_SIZE.1 / 2.;
    let mut tile_sprite: Handle<Image>;

    for row_idx in 0..board_size.y + 8 {
        for column_idx in 0..board_size.x + 4 {

            if row_idx < 3 || row_idx > board_size.y + 4 {
                ...
                else if column_idx == board_size.x + 3 {
                    tile_sprite = game_textures.tile_top_right_corner.clone();
                }
                else {
                    tile_sprite = game_textures.tile_top.clone();
                }
            }
            else if row_idx == board_size.y + 4 {
                if column_idx == 0 {
                    tile_sprite = game_textures.tile_bottom_left_corner.clone();
                }
            ...
            else if row_idx == board_size.y + 3 {
                if column_idx < 2 {
                    tile_sprite = game_textures.tile_road_enter.clone();
                }
                else if column_idx == 2 {
                ...
                else if column_idx == board_size.x + 2 {
                ...
                if column_idx == 0 {
                    ...
                    tile_sprite = game_textures.tile_exit_bottom_02.clone();
                }
                else {
                    tile_sprite = game_textures.tile_road.clone();
                }
            }
            else if row_idx == board_size.y + 2 {
                if column_idx == 0 {
                    tile_sprite = game_textures.tile_enter_top_02.clone();
                }
                else if column_idx == 1 {
                ...
                if column_idx == 0 || column_idx == board_size.x + 3 {
                    tile_sprite = game_textures.tile_background.clone();
                }
                else if column_idx == 1 {
                    tile_sprite = game_textures.tile_left.clone();
            ...
            tile_spawn_system(&mut commands, tile_sprite, Vec3::new(start_x + TILE_SIZE.0 * column_idx as f32, start_y - TILE_SIZE.1 * row_idx as f32, 0.), None);
        }
    }
}
